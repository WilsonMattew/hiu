  ...
  // constructor
    ...
    function getVideoDetails($url)
	{
		...
		if ($host == 'vimeo') {
			...
			$hash = json_decode(file_get_contents("https://www.googleapis.com/youtube/v3/videos?part=snippet,contentDetails&id=".$video_id."&key=".$youtube_api_key, false, stream_context_create($arrContextOptions)));
	...
	function get_html5_video_info($video_file_path = ""){
		include_once('application/libraries/getid3-video-master/getid3.php');
		$getID3 = new getID3();
        return $getID3->analyze($video_file_path);
	}
}
