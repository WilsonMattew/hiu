...
class Install extends CI_Controller {
  ...
  function validate_purchase_code() {
    ...
    $validation_response = $purchase_code;
  ...
  function step3($param1 = '', $param2 = '') {
    ...
    // FateKid - REMOVED LICENSE RE-VALIDATION | $this->check_purchase_code_verification();
  ...
  function finalizing_setup($param1 = '', $param2 = '') {
    ...
    if ($param1 == 'setup_admin') {
      ...
      $admin_data['date_added'] = time();
      $admin_data['is_verified']    = 1;
      $admin_data['status']    = 1;
      $admin_data['social'] = '{"facebook":"","twitter":"","linkedin":"","website":""}';
  ...
  function success($param1 = '') {
    ...
    $this->load->database();
    $admin_email = $this->db->get_where('user', array('role' => 'admin'))->row('email');
