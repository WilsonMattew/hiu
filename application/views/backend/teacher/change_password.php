	...
	<div class="col-lg-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                <form action="<?php echo site_url('teacher/change_password/updated'); ?>" method="post" enctype="multipart/form-data" role="form" class="form-horizontal form-groups-bordered">
