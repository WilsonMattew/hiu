<div class="row ">
  <div class="col-lg-12">
    <a href="<?php echo site_url('teacher/add_class'); ?>" class="btn btn-primary alignToTitle"><i class="entypo-plus"></i><?php echo get_phrase('add_new_class'); ?></a>
  </div><!-- end col-->
</div>
...
<script>
  $(document).ready(function () {
     var table = $('#classes_server_side_data').DataTable({
      ...
      "serverSide": true,
      "ajax":{
        "url": "<?php echo base_url('teacher/classes_server_side_data') ?>",
        "dataType": "json",
        "type": "POST",
