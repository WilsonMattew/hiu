<?php
// Paypal Keys
$paypal_settings = get_settings('paypal_keys');
  ...
  <div class="col-lg-7">
    <div class="panel panel-primary" data-collapsed="0">
      ...
      <div class="panel-body">
        <form action="<?php echo site_url('admin/payment_settings/system_currency'); ?>" method="post" enctype="multipart/form-data" role="form" class="form-horizontal form-groups-bordered">
      ...
      <div class="panel-body">
        <form action="<?php echo site_url('admin/payment_settings/paypal_settings'); ?>" method="post" enctype="multipart/form-data" role="form" class="form-horizontal form-groups-bordered">
          <div class="form-group">
            ...
            <div class="col-sm-7">
              <select name="paypal_active" id = "paypal_active" class="form-control" data-allow-clear="true" data-placeholder="<?php echo get_phrase('paypal_active'); ?>">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-7">
            <select name="paypal_mode" id = "paypal_mode" class="form-control" data-allow-clear="true" data-placeholder="<?php echo get_phrase('paypal_mode'); ?>">
        ...
        <div class="form-group">
      		<label for="name" class="col-sm-3 control-label"><?php echo get_phrase('sandbox_client_id'); ?></label>
      		<div class="col-sm-7">
        ...
        <div class="form-group">
          <label for="name" class="col-sm-3 control-label"><?php echo get_phrase('sandbox_secret_key'); ?></label>
          <div class="col-sm-7">
            <input type="text" class="form-control" name="sandbox_secret_key" id="sandbox_secret_key" placeholder="<?php echo get_phrase('sandbox_secret_key'); ?>"  value="<?php echo $paypal[0]->sandbox_secret_key;?>" required >
          </div>
        </div>

        <div class="form-group">
      		<label for="production_client_id" class="col-sm-3 control-label"><?php echo get_phrase('production_client_id'); ?></label>
      		<div class="col-sm-7">
        ...
        <div class="form-group">
          <label for="production_secret_key" class="col-sm-3 control-label"><?php echo get_phrase('production_secret_key'); ?></label>
          <div class="col-sm-7">
            <input type="text" class="form-control" name="production_secret_key" id="production_secret_key" placeholder="<?php echo get_phrase('production_secret_key'); ?>"  value="<?php echo $paypal[0]->production_secret_key;?>" required >
          </div>
        </div>
      ...
      <div class="panel-body">
        <form action="<?php echo site_url('admin/payment_settings/stripe_settings'); ?>" method="post" enctype="multipart/form-data" role="form" class="form-horizontal form-groups-bordered">
          <div class="form-group">
            ...
            <div class="col-sm-7">
              <select name="stripe_active" id = "stripe_active" class="form-control" data-allow-clear="true" data-placeholder="<?php echo get_phrase('stripe_active'); ?>">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-7">
            <select name="testmode" id = "testmode" class="form-control" data-allow-clear="true" data-placeholder="<?php echo get_phrase('test_mode'); ?>">
