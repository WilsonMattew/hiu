            ...
            <tbody>
                ...
                foreach($all_requests->result_array() as $key => $all_request){
                    ...
                    <tr>
                        ...
                        <td>
                            <strong>
                                <a href="<?php echo site_url('admin/manage_class/'.$class['class_id']); ?>">
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-blue dropdown-menu-right" role="menu">
                                    <li><a href="<?php echo site_url('classes/'.slugify($class['class_title']).'/'.$class['class_id']); ?>" target="_blank"><?php echo get_phrase("review_this_class"); ?></a>
                                    </li>

                                    <li><a href="javascript:;" onclick="showAjaxModal('<?php echo site_url('admin/class_approval/view_message/'.$all_request['notification_id']); ?>', '<?php echo get_phrase('teachers_mail'); ?>')"><?php echo get_phrase("view_message"); ?></a>
                                    </li>

                                    <li><a href="javascript:;" onclick="showAjaxModal('<?php echo site_url('admin/class_approval_mail_form/approved/'.$all_request["notification_id"]); ?>', '<?php echo get_phrase("approve_the_request"); ?>')"><?php echo get_phrase("approve_the_request"); ?></a>
                                    </li>

                                    <li><a href="javascript:;" onclick="showAjaxModal('<?php echo site_url('admin/class_approval_mail_form/canceled/'.$all_request["notification_id"]); ?>', '<?php echo get_phrase("reject_the_request"); ?>')"><?php echo get_phrase("reject_the_request"); ?></a>
                                    </li>

                                    <li><a href="javascript:;" onclick="confirm_modal('<?php echo site_url('admin/class_approval/delete/'.$all_request["notification_id"]); ?>')"><?php echo get_phrase("delete"); ?></a>
                                    </li>
                                </ul>
                            </div>
                        </td>
