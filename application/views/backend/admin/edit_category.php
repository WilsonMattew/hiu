		...
		<div class="panel panel-primary" data-collapsed="0">
			<div class="panel-heading">
				<div class="panel-title">
					<?php echo get_phrase('category_edit_form'); ?>
				</div>
			</div>
			<div class="panel-body">
				<form action="<?php echo site_url('admin/categories/update/'.$category['category_id']); ?>" method="post" enctype="multipart/form-data" role="form" class="form-horizontal form-groups-bordered">

					<div class="form-group">
						<label for="name" class="col-sm-3 control-label"><?php echo get_phrase('category_title'); ?></label>

						<div class="col-sm-7">
							<input type="text" class="form-control" name="title" id="name" placeholder="<?php echo get_phrase('provide_category_name'); ?>" value="<?php echo $category['title']; ?>" required>
						</div>
					</div>
					...
					<div class="form-group" id = "icon-picker-area">
						...
						<div class="col-sm-7">
							<input type="text" name="icon_class" class="form-control icon-picker" autocomplete="off" value="<?php echo $category['icon_class']; ?>">
						</div>
					</div>
						...
						<div class="col-sm-7">
							<div class="fileinput fileinput-new" data-provides="fileinput">
								<div class="fileinput-new thumbnail" style="width: 200px; height: 200px;" data-trigger="fileinput">
									<img src="<?php echo get_category_thumbnail($category['thumbnail']); ?>" alt="...">
								</div>
