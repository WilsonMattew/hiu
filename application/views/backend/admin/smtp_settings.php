  ...
  <div class="col-lg-8">
    <div class="panel panel-primary" data-collapsed="0">
      ...
      <div class="panel-body">
        <form action="<?php echo site_url('admin/smtp_settings/updated'); ?>" method="post" enctype="multipart/form-data" role="form" class="form-horizontal form-groups-bordered">
...
<div class="row">
  <div class="col-lg-8">
    <div class="panel panel-primary" data-collapsed="0">
      <div class="panel-heading">
        <div class="panel-title">
          <?php echo get_phrase('email_template'); ?>
        </div>
      </div>
      <div class="panel-body">
        <form class="realtime-form" action="<?php echo site_url('admin/email_template/updated'); ?>" method="post" enctype="multipart/form-data" role="form" class="form-horizontal form-groups-bordered">

          <div class="form-group">
            <label for="email_verification_mail" class="control-label"><?php echo get_phrase('email_verification_mail'); ?></label>
            <textarea class="form-control common_editor" name="email_verification_mail"><?php echo get_settings('email_verification_mail'); ?></textarea>
          </div>

          <div class="form-group">
            <label for="account_access_mail" class="control-label"><?php echo get_phrase('account_access_mail'); ?></label>
            <textarea class="form-control common_editor" name="account_access_mail"><?php echo get_settings('account_access_mail'); ?></textarea>
          </div>

          <div class="form-group">
            <label for="forgot_password_mail" class="control-label"><?php echo get_phrase('forgot_password_mail'); ?></label>
            <textarea class="form-control common_editor" name="forgot_password_mail"><?php echo get_settings('forgot_password_mail'); ?></textarea>
          </div>
