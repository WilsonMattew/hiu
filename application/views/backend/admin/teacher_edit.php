<div class="row ">
  <div class="col-lg-12">
    <a href="<?php echo site_url('admin/teachers'); ?>" class="btn btn-primary alignToTitle"><i class="fa fa-reply"></i> <?php echo get_phrase('back'); ?></a>
  </div><!-- end col-->
</div>
...
<div class="panel panel-primary" data-collapsed="0">
	...
	<div class="panel-body">
		<form action="<?php echo site_url('admin/teachers/updated/'.$teacher['user_id']); ?>" method="post" enctype="multipart/form-data">
			<div class="row mb-15px">
				<label for="first_name" class="col-sm-3 control-label text-right pt-5px"><?php echo get_phrase('name'); ?>*</label>
				<div class="col-sm-7">
					<input type="text" value="<?php echo $teacher['first_name']; ?>" class="form-control float-left brr-0 w-50 mr-0px" name="first_name" id="first_name" placeholder="<?php echo get_phrase('enter_first_name'); ?>" required>

					<input type="text" value="<?php echo $teacher['last_name']; ?>" class="form-control float-left brl-0 w-50 ml-0px" name="last_name" id="last_name" placeholder="<?php echo get_phrase('enter_last_name'); ?>">
				</div>
			</div>
			...
			<div class="row mb-15px">
				...
				<div class="col-sm-7">
					<input type="text" value="<?php echo $teacher['surname']; ?>" class="form-control" name="surname" id="surname" placeholder="<?php echo get_phrase('designation'); ?>">
				</div>
			</div>
			...
			<div class="row mb-15px">
				...
				<div class="col-sm-7">
					<input type="text" value="<?php echo $teacher['phone']; ?>" class="form-control" name="phone" id="phone" placeholder="<?php echo get_phrase('phone_number'); ?>">
				</div>
			</div>
			...
			<div class="row mb-15px">
				...
				<div class="col-sm-7">
					<textarea class="form-control" rows="3" name="address" id="address" placeholder="<?php echo get_phrase('address'); ?>"><?php echo $teacher['address']; ?></textarea>
				</div>
			</div>
			...
			<div class="row mb-15px">
				...
				<div class="col-sm-7">
					<textarea class="form-control" rows="4" name="about" id="common_editor" placeholder="<?php echo get_phrase('about'); ?>"><?php echo $teacher['about']; ?></textarea>
				</div>
			</div>
				...
				<div class="col-sm-7">
					<div class="fileinput fileinput-new float-left mr-10px" data-provides="fileinput">
						<div class="fileinput-new thumbnail" data-trigger="fileinput">
							<img width="200px" src="<?php echo get_user_image($teacher['user_id']); ?>" alt="...">
						</div>
			...
			<?php $social = json_decode($teacher['social']); ?>
