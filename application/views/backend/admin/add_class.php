<a href="<?php echo site_url('admin/classes'); ?>" class="btn btn-primary alignToTitle"><i class="fa fa-reply"></i> <?php echo get_phrase('back_to_list'); ?></a>
...
<div class="panel panel-primary" data-collapsed="0">
	...
	<div class="panel-body">
		<form class="realtime-form" action="<?php echo site_url('admin/add_class/added'); ?>" method="post" enctype="multipart/form-data">
