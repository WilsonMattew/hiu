...
<div class="panel panel-primary" data-collapsed="0">
	...
	<div class="panel-body">
		<form action="<?php echo site_url('admin/teachers/added'); ?>" method="post" enctype="multipart/form-data">
			...
			<div class="row mb-15px">
				...
				<div class="col-sm-7">
					<button class="btn btn-primary" type="submit"><?php echo get_phrase('add_teacher'); ?></button>
				</div>
			</div>
		</form>
	</div>
