<?php $my_reviews = $this->frontend_model->get_reviews_user_and_class($class_details['class_id'])->row_array(); ?>
<div class="container-fluid bg-body pb-12px">
	<div class="row">
		...
		<div class="col-lg-8">
			...
			<form class="realtimeLeavReview" action="<?php echo site_url('classes/update_review?class_id='.$class_details['class_id'].'&review_id='.$my_reviews['review_id']); ?>" method="post" enctype="multipart/form-data">
				<div class="w-100 bg-white mb-4 pb-4">
					...
					<div class="row justify-content-center">
						<div class="col-xs-6 col-sm-6 col-md-2">
							<input value="0" type="radio" class="btn-check" name="expectation" id="not_really" autocomplete="off" <?php if($my_reviews['expectation'] == 0)echo 'checked'; ?> required>
						...
						<div class="col-xs-6 col-sm-6 col-md-2">
							<input value="1" type="radio" class="btn-check" name="expectation" id="somewhat" autocomplete="off" <?php if($my_reviews['expectation'] == 1)echo 'checked'; ?> required>
						...
						<div class="col-xs-6 col-sm-6 col-md-2">
							<input value="2" type="radio" class="btn-check" name="expectation" id="yes" autocomplete="off" <?php if($my_reviews['expectation'] == 2)echo 'checked'; ?> required>
						...
						<div class="col-xs-6 col-sm-6 col-md-2">
							<input value="3" type="radio" class="btn-check" name="expectation" id="exceeded" autocomplete="off" <?php if($my_reviews['expectation'] == 3)echo 'checked'; ?> required>
				...
				<div class="w-100 bg-white mb-4 pb-4">
					...
					<div class="row justify-content-center">
						<div class="col-xs-6 col-sm-6 col-md-2">
							<input value="beginner" type="radio" class="btn-check" name="level" id="beginner" autocomplete="off" <?php if($my_reviews['level'] == 'beginner')echo 'checked'; ?> required>
						...
						<div class="col-xs-6 col-sm-6 col-md-2">
							<input value="intermediate" type="radio" class="btn-check" name="level" id="intermediate" autocomplete="off" <?php if($my_reviews['level'] == 'intermediate')echo 'checked'; ?> required>
						...
						<div class="col-xs-6 col-sm-6 col-md-2">
							<input value="advanced" type="radio" class="btn-check" name="level" id="advanced" autocomplete="off" <?php if($my_reviews['level'] == 'advanced')echo 'checked'; ?> required>
						...
						<div class="col-xs-6 col-sm-6 col-md-2">
							<input value="all" type="radio" class="btn-check" name="level" id="any_level" autocomplete="off" <?php if($my_reviews['level'] == 'all')echo 'checked'; ?> required>
				...
				<div class="w-100 bg-white mb-4 pb-4">
					...
					<div class="row justify-content-center">
						...
						<?php foreach($review_tags as $review_tag): ?>
							<div class="col-auto">
								<input type="radio" value="<?php echo $review_tag['review_tag_id'] ?>" class="btn-check" name="review_tag_id" id="tag_<?php echo $review_tag['review_tag_id'] ?>" autocomplete="off" <?php if($review_tag['review_tag_id'] == $my_reviews['review_tag_id'])echo 'checked'; ?> required>
				...
				<div class="w-100 bg-white mb-4 pb-4">
					...
					<div class="row justify-content-center">
						<div class="col-md-10">
							<textarea class="form-control" rows="4" name="comment"><?php echo $my_reviews['comment']; ?></textarea>
						</div>
					</div>
				</div>
				...
				<div class="row my-4">
					<div class="col-md-12 text-center">
						<button type="submit" class="mstr-header-btn-pro"><?php echo get_phrase('update_review'); ?></button>
					</div>
				</div>
			</form>
		</div>
	    ...
	    $('.realtimeLeavReview').ajaxForm({
	        ...
	        complete: function(xhr) {
	        	...
	        	if(jsonResponse.status == 'error'){
		        	...
		        	load_class_data('', jsonResponse.class_id, 'reviews');
