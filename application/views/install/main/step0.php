    ...
    <div class="panel panel-default" data-collapsed="0"
      style="border-color: #dedede;">
        ...
        <p style="font-size: 14px;">
          Welcome to Mastery subscription LMS Installation. You will need to know the following items before
          proceeding.
        </p>
        <ol>
          <li>NULLED BY <a href="https://nullforums.net/fate">FateKid</a> - <span style="font-weight:bold;color:orange;">NO LICENSE KEY REQUIRED</span></li>
          <li>Database Name</li>
