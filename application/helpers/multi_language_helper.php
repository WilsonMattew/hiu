...
if ( ! function_exists('get_phrase'))
{
    function get_phrase($phrase = '') {
        $CI	=&	get_instance();
        $CI->load->database();
        $active_language = $CI->db->get_where('settings' , array('type' => 'language'))->row('description');
        ...
        // $langArray = openJSONFile($active_language);
        ...
        //     file_put_contents(APPPATH.'language/'.$active_language.'.json', stripslashes($jsonData));
        // }
        // // THIS BLOCK OF CODE IS THE CORE FOR TRANSLATING
